...
function getAccessControlMiddleware(options) {
	...
	return (req, resp, next) => {
		...
		if (isCORSReq(req, config.cors) && isCORSPreflight(req)) {
			...
			// middleware chain - in cors.js/middleware and in apibuilder.js isCORSReq.
...
/**
 * Sends error.
 * @param {object} [err] - An error with id, statusCode, and message.  If not supplied, defaults are
 * @applied.
